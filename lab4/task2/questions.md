#### Отчет
Вывод содержимого первых 5 строк массива:
```bash
Обрабатываю Area_1...
  → 44,026,810 точек
Обрабатываю Area_2...
...
Обрабатываю Area_6...
 ...
 Всего точек: 273,546,487
Форма итогового массива: (273546487, 7) (столбцы: X, Y, Z, R, G, B, label)

Первые 5 строк:
[[0.84164992 0.17406822 0.22963644 0.27843137 0.25098039 0.21176471
  3.        ]
 [0.83231675 0.17892172 0.2236631  0.26666667 0.25098039 0.20392157
  3.        ]
 [0.83679677 0.17742779 0.22254309 0.2745098  0.23921569 0.20392157
  3.        ]
 [0.8371699  0.17593385 0.23000974 0.28235294 0.25490196 0.21568627
  3.        ]
 [0.84277002 0.17406822 0.22851643 0.27843137 0.24705882 0.20392157
  3.        ]]
  ```
Вывод исходя из диаграммы, представленной ниже: Класс wall — самый большой (75.9 млн точек), составляет ~28% всего датасета.
Класс clutter — второй по величине (28.3 млн), что говорит о высокой сложности сцены — много "фоновых" или неструктурированных объектов.
Класс stairs — самый редкий (менее 0.2% от общего числа) — требует особого внимания при обучении.

Модель может быть смещена в сторону доминирующих классов (wall, ceiling, floor, clutter).
Для корректной работы алгоритмов предположительно можно использовать взвешивание потерь (class weights), аугментация редких классов,подвыборку доминирующих классов (undersampling). 
