...
**Цель работы:**  
Познакомиться с основными командами работы со скалярными полями (Scalar Fields)
в CloudCompare и научиться применять их для анализа и обработки 3D-облачей точек.
...
![Рис. 1 - Исходное облако точек с цветовой информацией](lab2/task1/Pasted%20image%2020251209112551.png)
![Рис. 2 — Панель Properties](lab2/task1/Properties.png)
